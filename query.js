var Qy = (function(){
	...
	var query_parser = function(query, value) {
	    var query_comparisons = {
	        ...
	        "eq": function(b, a) { return a === b; },
	        "not": function(b, a) { return b !== a; },
	        "contain": function(b, a) { return a.indexOf(b) > -1; },
	        "rgx": function(b, a) { return a.match(b); } // if regex match any
	    };
	...
	var query_chainer = function(query) {
	    ...
	    return function(obj){
	        return comparison.every(function(f){ return f(obj); });
	    };
	};
